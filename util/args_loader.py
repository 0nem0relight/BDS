...
def get_args():
    ...
    parser.add_argument('--out-datasets', default=['SVHN', 'LSUN', 'iSUN', 'dtd', 'places365'], nargs="*", type=str, help="['SVHN', 'LSUN', 'iSUN', 'dtd', 'places365']  ['inat', 'sun50', 'places50', 'dtd', ]")
    parser.add_argument('--name', default="resnet18", type=str, help='neural network name and training set  resnet50-supcon')
    parser.add_argument('--model-arch', default='resnet18', type=str, help='model architecture resnet18-supcon')
